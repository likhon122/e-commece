        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {products.map((product) => {
            ...
            return (
              <div
                key={product._id}
                className="group mx-auto w-full max-w-[290px] rounded-2xl border border-[#B0E4CC]/40 bg-gradient-to-b from-white to-[#f8fffb] p-3.5 shadow-[0_14px_34px_-28px_rgba(24,50,39,0.6)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_22px_42px_-26px_rgba(24,50,39,0.6)]"
              >
                <div className="relative aspect-[4/5] overflow-hidden rounded-xl bg-secondary-100">
                  {imageUrl && (
                    <Image
                      src={imageUrl}
                      alt={product.name}
                  ...
                  <button
                    ...
                    className="absolute right-2 top-2 rounded-full bg-white/95 p-2 text-red-500 shadow-md backdrop-blur transition-colors hover:bg-red-50"
                  >
                ...
                <div className="mt-3.5">
                  ...
                  <Link href={`/products/${product.slug}`} className="line-clamp-2 text-[15px] font-semibold leading-snug text-secondary-900 hover:text-primary-600">
                    {product.name}
                  </Link>
